...
<input name="boardid" type="hidden" value="dd ">
 <table><br>
  <tr><td>板块名字：</td><td><input name="typename" type="text" maxlength="60"></td></tr>
  
  <tr><td>板块简介：</td><td><input name="typedesc" type="text" maxlength="60"></td></tr>
